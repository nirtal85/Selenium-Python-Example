...
class TestLogin(BaseTest):
    ...
    def test_invalid_login(self, email, password):
        ...
        assert_that(self._error_msg).is_equal_to(self.pages['login_page'].get_error_message())
    ...
    def test_valid_login(self, prep_properties):
        ...
        assert_that(self._page_title).is_equal_to(self.pages['projects_page'].get_title())
    ...
    def test_logout(self, prep_properties):
        ...
        assert_that('Log in').is_equal_to(self.pages['login_page'].get_page_title())
