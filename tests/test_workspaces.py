...
class TestWorkspaces:
    ...
    def test_create_new_workspace(self, prep_properties, projects_page, about_page, login_page):
    ...
    def test_rename_workspace(self,  prep_properties, projects_page, about_page, login_page):
        login(prep_properties, about_page, login_page)
        json_reader = JsonParser(self._DATA_FILE_NAME)
    ...
    def test_delete_workspace(self,  prep_properties, projects_page, about_page, login_page):
        login(prep_properties, about_page, login_page)
        before = projects_page.get_workspaces_number()
    ...
    def test_number_of_existing_projects(self,  prep_properties, projects_page, about_page, login_page):
        login(prep_properties, about_page, login_page)
    ...
    def test_add_project_to_workspace(self,  prep_properties, projects_page, about_page, login_page, project_type_page, templates_page, project_edit_page):
        login(prep_properties, about_page, login_page)
        json_reader = JsonParser(self._DATA_FILE_NAME)
    ...
    def test_search_project(self,  prep_properties, about_page, login_page, projects_page):
        login(prep_properties, about_page, login_page)
        json_reader = JsonParser(self._DATA_FILE_NAME)
    ...
    def test_search_for_non_existing_project(self,  prep_properties, about_page, login_page, projects_page):
        login(prep_properties, about_page, login_page)
        json_reader = JsonParser(self._DATA_FILE_NAME)
    ...
    def test_cancel_project_deletion(self,  prep_properties, projects_page, about_page, login_page):
        login(prep_properties, about_page, login_page)
        json_reader = JsonParser(self._DATA_FILE_NAME)
        before = projects_page.get_projects_number_in_page()
    ...
    def test_delete_project(self,  prep_properties, projects_page, about_page, login_page):
        login(prep_properties, about_page, login_page)
        json_reader = JsonParser(self._DATA_FILE_NAME)
        before = projects_page.get_projects_number_in_page()
