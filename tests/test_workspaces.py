...
class TestWorkspaces:
    ...
    @allure.title("Rename workspace test")
    ...
    @allure.title("Number of displayed projects assertion test")
    ...
    @allure.title("Add new project to workspace test")
    ...
    @allure.title("Search for an existing project test")
    ...
    @allure.title("Search for a non existing project test")
    ...
    @allure.title("Cancel deletion of a project test")
    ...
    @allure.title("Delete a project test")
