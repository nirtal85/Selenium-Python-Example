...
class ProjectsPage(TopNavigateBar):
    ...
    _CREATE_NEW_WORKSPACE_BUTTON: Tuple[str, str] = (By.CSS_SELECTOR, ".font-medium button")
    _WORKSPACE_EDIT_BUTTON: Tuple[str, str] = (By.CSS_SELECTOR, "[data-icon='chevron-down']")
    _RENAME_WORKSPACE_BUTTON: Tuple[str, str] = (By.CSS_SELECTOR, ".mr-3 .hover\\:bg-gray-600")
    ...
    _NEW_WORKSPACE_NAME_FIELD: Tuple[str, str] = (By.CSS_SELECTOR, "[placeholder='Workspace name']")
    ...
    _CONFIRM_DELETE_PROJECT_BUTTON: Tuple[str, str] = (By.CSS_SELECTOR, "#confirm-delete-button")
    _CANCEL_PROJECT_DELETION_BUTTON: Tuple[str, str] = (By.CSS_SELECTOR, "form [type=button]")
    _PROJECT_PAGE_TITLE: Tuple[str, str] = (By.CSS_SELECTOR, "#app h1.leading-tight.truncate")
    _NO_PROJECT_FOUND_MSG: Tuple[str, str] = (By.CSS_SELECTOR, "#app h1.block")
    _NUMBER_OF_PROJECTS_IN_WORKSPACE_BLOCK: Tuple[str, str] = (By.CSS_SELECTOR, "span:nth-child(2)")
    _DROP_DOWN_BUTTON: Tuple[str, str] = (By.CSS_SELECTOR, ".justify-right button svg")
    _DELETE_PROJECT_BUTTON: Tuple[str, str] = (By.XPATH, "//button[text()='Delete Project']")
    _WORKSPACE_LIST: Tuple[str, str] = (By.CSS_SELECTOR, ".mt-6 a")
    _PROJECTS_BLOCK: Tuple[str, str] = (By.CSS_SELECTOR, "#app .max-w-full div .mt-4 > .mt-8 > div")
