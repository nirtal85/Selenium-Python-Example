...
class ProjectEditPage(BasePage):
    ...
    _THANK_YOU_PAGE_TYPE_BUTTON: Tuple[str, str] = (By.CSS_SELECTOR, "[for=select-single-outcome]")
    _OUTCOME_PAGES_TYPE_BUTTON: Tuple[str, str] = (By.CSS_SELECTOR, "[for=select-outcomes]")
    _START_EDITING_BUTTON: Tuple[str, str] = (By.CSS_SELECTOR, ".swal-button.swal-button--confirm")
